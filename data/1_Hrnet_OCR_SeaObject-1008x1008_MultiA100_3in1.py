...
model = dict(
        ...
        backbone=dict(
            type='HRNet',
            init_cfg=dict(
                checkpoint='/cluster/home/snf52395/.cache/mim/hrnet-w64_3rdparty_8xb32_in1k_20220120-19126642.pth',
                prefix='backbone',
                type='Pretrained'),
            # with_cp=True,
...
train_dataloader = dict(
    batch_size=1,   # Adjust to fit GPU memory, U-Net lighter than SAM
    num_workers=4,
...
work_dir = '/cluster/projects/nn10004k/packages_install/Hrnet_OCR_40k'
