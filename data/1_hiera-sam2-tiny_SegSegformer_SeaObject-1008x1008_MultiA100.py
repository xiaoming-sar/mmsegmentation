...
model = dict(
    backbone=dict(
        features_only=True,
        model_name='sam2_hiera_tiny.fb_r896_2pt1', #'sam2_hiera_small.fb_r896_2pt1'
        patch_size=7, 
        pretrained=True,
        type='TIMMBackbone'),
    data_preprocessor=dict(
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        '/cluster/projects/nn10004k/ml_SeaObject_Data/OASIs_dataset_patch1024_3in1/OASIs_dataset_patch1024_3in1_1024by1024',
        pipeline=[
...
work_dir = '/cluster/projects/nn10004k/packages_install/sam2_allTypes'
